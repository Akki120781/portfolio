...
summary: "Magic Portfolio is a comprehensive, MDX-based, SEO-friendly, responsive portfolio template built with akki and Next.js."
...
Magic Portfolio is a comprehensive, MDX-based, SEO-friendly, responsive portfolio template built with akki and Next.js.
...
Subscribe to the [akki Pro plan](https://once-ui.com/pricing) to extend the license to [Dopler CC](https://once-ui.com/products/magic-portfolio).
...
<CodeBlock compact marginBottom="16" codes={[
  {
    code: "git clone https://github.com/akki/magic-portfolio.git",
    language: "bash"
  }
]} />
